    ...
    return (
        <div className="flex flex-col items-center">
            <span className="text-sm text-gray-700 ">
                Showing <span className="font-semibold text-gray-900 text-gray-900">{offset + 1}</span> to{' '}
                <span className="font-semibold text-gray-900 text-gray-900">{offset + limit}</span> of{' '}
